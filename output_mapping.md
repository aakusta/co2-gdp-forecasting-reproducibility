...
| Appendix Table A6 | public_outputs/appendix_table_a6_lookback_sensitivity.csv | internal full reproduction pipeline using restricted ICAP-derived inputs | Aggregate lookback-sensitivity diagnostic; primary specification remains lookback=3. |
