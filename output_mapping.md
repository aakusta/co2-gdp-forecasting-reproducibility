...
This file maps the aggregate public outputs in this repository to the tables, appendix tables, and figures reported in the final revised manuscript.

| Manuscript item | Repository file | Notes |
|---|---|---|
| Table 5 | public_outputs/table5_co2_model_performance.csv | Aggregate CO₂ model-performance metrics. |
| Table 6 | public_outputs/table6_gdp_model_performance.csv | Aggregate GDP-growth model-performance metrics. |
| Table 7 | public_outputs/table7_permutation_feature_importance.csv | Aggregate permutation feature importance / model-reliance output. |
| Appendix Table A1 | public_outputs/appendix_table_a1_country_list_58_national_units.csv | 58-country primary national sample list. |
| Appendix Table A2 | public_outputs/appendix_table_a2_no_imputation_robustness.csv | No-imputation robustness check. |
...
| Appendix Figure A1 | public_outputs/appendix_figure_a1_missingness_correlation_matrix.png | Missingness correlation matrix. |
| Appendix Figure A2 | public_outputs/appendix_figure_a2_missingness_country_pattern.png | Country-level missingness pattern. |
