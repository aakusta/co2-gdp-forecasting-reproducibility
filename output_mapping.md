...
| Appendix Table A4 full grid output | public_outputs/appendix_hyperparameter_grid_full.csv | internal full reproduction pipeline using restricted ICAP-derived inputs | Full hyperparameter grid output used to support appendix sensitivity summary. |
